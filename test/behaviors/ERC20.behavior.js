...
function shouldBehaveLikeERC20 (errorPrefix, supply, initialSupply, initialHolder, recipient, anotherAccount) {
  ...
  describe('balanceOf', function () {
    ...
    describe('when the requested account has some tokens', function () {
      ...
      it('returns the total amount of tokens', async function () {
        expect(await this.token.balanceOf(initialHolder)).to.be.bignumber.equal(supply);
      });
    });
  });
  ...
  describe('transfer', function () {
    ...
    shouldBehaveLikeERC20Transfer(errorPrefix, initialHolder, recipient, supply,
    ...
    describe('when the token owner is not the zero address', function () {
      ...
      describe('when the recipient is not the zero address', function () {
        ...
        describe('when the spender has enough approved balance', function () {
          beforeEach(async function () {
            await this.token.mint(tokenOwner, supply, { from: tokenOwner });
            await this.token.approve(spender, supply, { from: tokenOwner });
          });
        ...
        describe('when the spender does not have enough approved balance', function () {
          beforeEach(async function () {
            await this.token.mint(tokenOwner, supply, { from: tokenOwner });
            await this.token.approve(spender, supply.subn(1), { from: tokenOwner });
          });
  ...
  describe('approve', function () {
    shouldBehaveLikeERC20Approve(errorPrefix, initialHolder, recipient, supply,
