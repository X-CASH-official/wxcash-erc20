...
console.log(`| Provider URI: ${PROVIDER_URI}`);
console.log(`| VERIFY_API_KEY: ${VERIFY_API_KEY}`);
...
module.exports = {
  ...
  networks: {
    mainnet: {
      provider: () => new HDWalletProvider(MNEMONIC, PROVIDER_URI),
      network_id: 1,          // Mainnet's id
      gas: 8000000,           // Ropsten has a lower block limit than mainnet
      gasPrice: 11000000000,  // 10 gwei
